package xyz.zenan.sample.googleiab;
...
public class MainActivity extends Activity implements IabBroadcastReceiver.IabBroadcastListener, OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        String base64EncodedPublicKey = "";
    ...
    public void updateUi() {
        ...
        ImageView infiniteGasButton = findViewById(R.id.infinite_gas_button);
        if (mSubscribedToInfiniteGas) {
